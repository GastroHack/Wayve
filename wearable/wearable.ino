...
// Colors
#define HUE_LOCAL 125 // main color (cyan)
#define SAT_LOCAL 220
#define HUE_POI 40    // secondary color (orange)
#define SAT_POI 255
DEFINE_GRADIENT_PALETTE(cyan_p) { // gradient palette
  0,   0, 120, 90,
  85,  0,  80,  45,
  170, 0,  30,  10,
  255, 0,   0,   0
};
CRGBPalette256 my_gradient = cyan_p;
